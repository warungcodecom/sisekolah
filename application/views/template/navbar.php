<header class="main-header">
    ...
    <a href="<?php echo base_url('assets'); ?>/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Sisfo</b>Sekolah</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="<?php echo base_url('assets'); ?>/#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(''); ?>/upload/resize/<?php echo $this->session->userdata('photo'); ?>" class="user-image" alt="User Image">
            <?php 
...
foreach ($guru as $key) {
 echo"<span class='hidden-xs'>".$key->nama."</span>";   # code...
}
          ...
          ?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <img src="<?php echo base_url(''); ?>/upload/resize/<?php echo $this->session->userdata('photo'); ?>" class="img-circle" alt="User Image">

                <p>
                 <?php echo $this->session->userdata('u_name'); ?> / <?php echo $this->session->userdata('role'); ?>
